...
/**
 * _getenv - creates environment
 * @name: variable name for environment
 * Return: On success value of @name, NULL if fail.
 **/
...
/**
 * which - locates directory to be used
 * @filename: declared variable
 * @info: Arguments passed
 * Return: pointer string with found path or NULL if fail
 */
...
/**
 * is_current_path - checks arrangement of path
...
/**
 * get_full_env - gets the environment
 * Return: void
 **/
